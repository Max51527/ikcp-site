...
(function () {
  ...
  var SHOW_ON = ['dashboard', 'patrimoine', 'patrimoine-pro', 'diagnostic', 'simulateurs', 'score', 'priorites', 'famille', 'univers', 'conciergerie', 'collections', 'veille', 'carnet', 'documents', 'profil', 'securite'];
  ...
  var OTHERS = {
    ...
    patrimoine: { id:'patrimoine', label: 'Patrimoine', href: '/app/patrimoine-pro', match: ['patrimoine', 'patrimoine-pro', 'diagnostic', 'simulateurs', 'score', 'priorites'],
  ...
  function mountFb() {
    ...
    fcss.textContent = '.ikcp-fb{position:fixed;right:15px;bottom:calc(152px + env(safe-area-inset-bottom));z-index:151;background:var(--accent,#C9A96E);color:#0E1729;border:0;border-radius:999px;padding:10px 15px;font:600 12.5px Outfit,system-ui,sans-serif;box-shadow:0 10px 26px -10px rgba(14,23,41,.55);cursor:pointer}'
