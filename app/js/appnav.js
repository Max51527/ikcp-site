...
(function () {
  ...
  var OTHERS = {
    ...
    patrimoine: { id:'patrimoine', label: 'Bilan', href: '/app/bilan', match: ['bilan', 'recueil', 'patrimoine', 'patrimoine-pro', 'diagnostic', 'simulateurs', 'score', 'priorites', 'strategies-dirigeant', 'fiches'],
